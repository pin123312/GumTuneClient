...
public class WorldScanner {
    ...
    private static final HashMap<String, String[]> alternativeNames = new HashMap<String, String[]>() {{
        ...
        put("§9Corleone", new String[] { "§9Corleone", "§9Boss Corleone" });
    }};
    private static final HashMap<String, String> internalSkytilsNames = new HashMap<String, String>() {{
        ...
        put("§9Corleone", "internal_corleone");
    }};
            ...
            for (int y = 0; y < 200; y++) {
                for (int z = 0; z < 16; z++) {
                    if (WorldScannerFilter.worldScannerCHCrystals && LocationUtils.currentIsland == LocationUtils.Island.CRYSTAL_HOLLOWS) {
                        ...
                        // corleone
                        if (!currentWorld.getCrystalWaypoints().containsKey("§9Corleone") && chunk.getBlock(x, y, z) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x + 1, y, z) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x - 1, y, z) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x, y, z + 1) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x, y, z - 1) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x, y + 1, z) == Blocks.stone &&
                                chunk.getBlock(x + 1, y + 1, z) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x - 1, y + 1, z) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x, y + 1, z + 1) == Blocks.stone_brick_stairs &&
                                chunk.getBlock(x, y + 1, z - 1) == Blocks.stone_brick_stairs) {
                            sendCoordinatesMessage("§9Corleone", chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z);
                            addToSkytilsMap("§9Corleone", chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z);
                            currentWorld.updateCrystalWaypoints("§9Corleone", new BlockPos(chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z));
                            currentWorld.updateCrystalWaypoints("§0Nucleus", new BlockPos(513, 115, 513));
                            return;
                        }
                        if (!currentWorld.getCrystalWaypoints().containsKey("§9Corleone") && chunk.getBlock(x, y, z) == Blocks.double_stone_slab &&
                                chunk.getBlock(x + 2, y, z) == Blocks.glowstone &&
                                chunk.getBlock(x - 2, y, z) == Blocks.glowstone &&
                                chunk.getBlock(x, y, z + 2) == Blocks.glowstone &&
                                chunk.getBlock(x, y, z - 2) == Blocks.glowstone &&
                                chunk.getBlock(x + 2, y + 1, z) == Blocks.carpet &&
                                chunk.getBlock(x - 2, y + 1, z) == Blocks.carpet &&
                                chunk.getBlock(x, y + 1, z + 2) == Blocks.carpet &&
                                chunk.getBlock(x, y + 1, z - 2) == Blocks.carpet) {
                            sendCoordinatesMessage("§9Corleone", chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z);
                            addToSkytilsMap("§9Corleone", chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z);
                            currentWorld.updateCrystalWaypoints("§9Corleone", new BlockPos(chunk.xPosition * 16 + x, y + 10, chunk.zPosition * 16 + z));
                        ...
                        /*
                        if (!currentWorld.getCrystalWaypoints().containsKey("§dCorleone") && chunk.getBlock(x, y, z) == Blocks.planks &&
                                chunk.getBlock(x, y + 1, z) == Blocks.cobblestone_wall &&
                                chunk.getBlock(x, y + 2, z) == Blocks.iron_bars &&
                                chunk.getBlock(x, y + 3, z) == Blocks.cobblestone_wall &&
                                chunk.getBlock(x, y + 4, z) == Blocks.iron_bars) {
                            sendCoordinatesMessage("§dCorleone", chunk.xPosition * 16 + x + 20, y, chunk.zPosition * 16 + z + 1);
                            addToSkytilsMap("§dCorleone", chunk.xPosition * 16 + x + 20, y, chunk.zPosition * 16 + z + 1);
                            currentWorld.updateCrystalWaypoints("§dCorleone", new BlockPos(chunk.xPosition * 16 + x + 20, y, chunk.zPosition * 16 + z + 1));
                            return;
                        }
                        */
                    }
                    ...
                    if (WorldScannerFilter.worldScannerCHFairyGrottos && LocationUtils.currentIsland == LocationUtils.Island.CRYSTAL_HOLLOWS && y < 64) {
